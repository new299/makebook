...
import (
	"github.com/new299/makebook/sites"
	"net/http"
	"fmt"
	"strings"
)
...
func main() {
  fmt.Println("Registering handlers");
	...
	http.HandleFunc("/down"   , makeHandler(sites.GraphJSONDownHandler))
	http.HandleFunc("/graph"  , makeHandler(sites.GraphJSONFormHandler))
